  ...
  const generatePDF = async () => {
    try {
      ...
      reader.onloadend = () => {
        ...
        doc.setFontSize(16);
        doc.text("Supplier Registry Report", pageWidth / 2, 32, {
          align: "center",
        });
        ...
        if (
          ...
          if (filters.search) {
            doc.text(`Search: ${filters.search}`, 14, yPosition);
            yPosition += 6;
          }
          if (filters.status) {
          ...
          if (filters.county) {
            doc.text(`County: ${filters.county}`, 14, yPosition);
            yPosition += 6;
          }
          yPosition += 5;
        }
        ...
        (doc as any).autoTable({
          ...
          columnStyles: {
            ...
            1: { cellWidth: 25 }, // Registration Type
            2: { cellWidth: 25 }, // Reg. Number
            3: { cellWidth: 25 }, // Director
            4: { cellWidth: 20 }, // County
            5: { cellWidth: 25 }, // Supply Category
        ...
        // Save the PDF
        const fileName = `TUM_Suppliers_Report_${
