...
export default function ImportAssetsPage() {
  ...
  const isRestrictedUser =
    user && user.role !== "admin" && user.department !== "Procurement";
          ...
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Bulk import assets using Excel spreadsheet
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <ul className="list-disc list-inside space-y-1">
                      <li>
                        Download the template file and fill in your asset data
                      </li>
            ...
            {isRestrictedUser && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                <div className="flex items-start">
                  <div className="w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <i className="ri-warning-line text-amber-600"></i>
                  </div>
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-amber-800">
                      Department Restricted Import
                    </h3>
                    <div className="mt-2 text-sm text-amber-700">
                      <p>
                        All assets from your import file will be assigned to
                        your department: <strong>{user?.department}</strong>
                      </p>
                      <p>
                        Any department values in the Excel file will be
                        overridden to ensure proper access control.
                      </p>
                    </div>
                  </div>
                </div>
