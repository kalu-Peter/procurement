...
export default function NewAssetPage() {
  ...
  const generateAssetTag = (category: string, department: string) => {
    const categoryCode = mockCategories.find(c => c.name === category)?.code || 'GEN';
    const departmentCode = mockDepartments.find(d => d.name === department)?.code || 'GEN';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:8000/api/assets/create.php', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...formData,
          asset_tag: formData.category && formData.department ? generateAssetTag(formData.category, formData.department) : '',
        }),
      });
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center py-20">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center max-w-md">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Asset Created Successfully!</h2>
            <p className="text-gray-600 mb-4">The new asset has been added to the system.</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Create a new asset record in the system</p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={formData.category && formData.department ? generateAssetTag(formData.category, formData.department) : ''}
              ...
              <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                <Link href="/assets" className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition duration-200 cursor-pointer whitespace-nowrap">
                  Cancel
                </Link>
                <button
                  type="submit"
